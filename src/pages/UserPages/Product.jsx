...
<div className="rounded-2xl overflow-hidden bg-white h-[400px] w-full flex items-center justify-center">
  ...
  <p>
    Engineered for optimal comfort and lasting performance, this garment is crafted 
    from premium, breathable fabric blends designed to move with you. Whether on 
    the field, at training, or styled for everyday wear, it delivers a tailored, 
    ergonomic fit without compromising on durability.
  </p>

  <p>
    Featuring reinforced stitching, advanced moisture-wicking properties, and fade-resistant 
    dye technology, every piece is built to withstand high-intensity wear and repeated 
    washing while maintaining its structure and original soft feel.
  </p>
</div>
  </div>
